...
<body>
  ...
  <div class="topnav">
    ...
    <?php if ($accounttype == 2) echo '<a id="buttonManageStore" href="./storeManagement.php" style="font-family:Tahoma;letter-spacing:1px;">Store Management</a>'; ?>
    <div class="drop">
      <a id="buttonAccount-Head" class="dropbtn" style="font-family:Tahoma;letter-spacing:1px;"><?php echo "Hello, $accountName"?></a>
      <div class="drop-content">
        <?php if($accounttype == 1) echo '<a id="buttonAdmin" href="./admin.php" style="font-family:Tahoma;letter-spacing:1px;">Admin Page</a>';?>
